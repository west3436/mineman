...
- Output: 100mb Ethylene (TFMG fluid, intermediate for plastic)
- Power: 512 RF
- Time: ~10 seconds
...
**Recipe**:
- Input: 100mb Ethylene (TFMG fluid)
...
A compact IE-themed multiblock that processes ethylene into solid unprocessed plastic.
...
2. **Plastic Solidifier Multiblock** (3x3x3 - Multiblocked2)
   ...
   - Processes ethylene + coal coke → unprocessed plastic
...
- Output: 125mb Molten Plastic (TFMG fluid)
- Power: 1024 RF (2x cost)

**Bottling Recipe**:
- Input: 1x Bucket
- Input: 125mb Molten Plastic (TFMG fluid)
...
### Output Automation
1. **Ethylene**: IE pipes between machines
...
- Ensure output tank has space for ethylene
...
### Recipe IDs
- `immersiveengineering:refinery/ethylene` - Oil to ethylene
- `immersiveengineering:bottling/unprocessed_plastic` - Ethylene to solid
...
- Intermediate: `tfmg:ethylene` (TFMG fluid for plastic production)
- Alternative: `tfmg:molten_plastic` (TFMG fluid for emergency recipe)
